      ...
      *> ERROR I got here: INITIAL naming was bad "WS-EMP-PAY-HIGHEST" instead OF "WS-EMP-PAY-HIGHEST-REC"
      *> such ambiguos name lead me comparing whole record to value.
       01  WS-EMP-PAY-HIGHEST-REC.
      ...
      *> Here could be checks for wrong names or non existing departments, but checking NUMERIC corruption is enough IMHO for training task.
       ...
       4200-PROCESS-SORTED-RECORD.
           ...
           IF WS-EMP-TOTAL-PAY-HIGHEST < SR-TOTAL-PAY
           ...
           IF WS-EMP-TOTAL-PAY-LOWEST > SR-TOTAL-PAY
